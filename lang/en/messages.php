...
return [
    ...
    'order' => [
        ...
        'cannot_update_payment' => 'Payment can only be updated for pending orders',
    ...
    'coupon' => [
        ...
        'minimum_not_met' => 'Minimum order amount of :min_order_amount EGP not met',
        'applied_successfully' => 'Coupon applied successfully. You save :discount EGP',
        'removed_successfully' => 'Coupon removed successfully',
        'vendor_mismatch' => 'This coupon is not valid for the selected vendor',
    ],
    'smart_order' => [
